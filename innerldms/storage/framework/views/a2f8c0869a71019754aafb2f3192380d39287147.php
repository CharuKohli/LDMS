       ...
       <div class="panel-body">
        <div class="col-md-12">
                  ...
                  <div id="insurancedetails" ></div>
                      ...
                      <div  id="rstable" style="padding-top:30px;padding-bottom:40px;padding-left:40px;padding-right:40px;background-color:white;border:solid 1px #LightGray;">
                            <div class="content1" name="resulttablen" style="" >
								<form class="form-horizontal" id="insurance" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-10">
                      <input class="form-control" type="text"  name="date" id="date"placeholder="Date" required>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.mainpage', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>