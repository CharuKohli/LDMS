...
<td>{{$reg_date}}</td>
<td>{{$renewal_date}}</td>
<td>{{$doc->count_doc_renewed}}</td>
<td>{{$doc->amount}}</td>
<td>{{$doc->doc_shared_to}}</td>
<td>
  <button type="button" class="btn btn-primary btn-xs showdocuments" value="{{$doc->id}}">View/Edit</button>

  <!-- @if($imgpath!=null)
  <button type="button" class="btn btn-primary btn-xs showbill" value="{{$doc->id}}">View/Edit</button>
    @endif -->
</td>
<td>
<button type="button"  class="btn btn-warning btn-xs editdoc" value="{{$doc->id}}"><span class="glyphicon glyphicon-pencil"></span> </button>
<button type="button"  class="btn btn-danger btn-xs deletedoc" value="{{$doc->id}}"><span class="glyphicon glyphicon-trash"></span> </button>
</td>
</tr>
@endforeach
