...
<br><br>
  ...
  <div style="margin:10px;font-weight:600">
   <p  class="dummyInline"> Insurance Name :<span style="color:blue"><?php echo e($doc_name); ?></span></p>
 </div>
    <?php
    $len=count($docid);
    ?>
...
<img src="<?php echo e($path); ?>" class="img-thumbnail" align="center"alt="no image">
<li class="delete" value="<?php echo e($imageid); ?>"><i class="fa fa-trash fa-lg"></i></li>
