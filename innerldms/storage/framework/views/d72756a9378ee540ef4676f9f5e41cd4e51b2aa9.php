...
<td><?php echo e($doc->company); ?></td>
<td><?php echo e($date); ?></td>
<td><?php echo e($doc->amt_paid); ?></td>
<td><?php echo e($exp_date); ?></td>
<td><?php echo e($doc->no_of_renewals); ?></td>
<td><?php echo e($doc->contact_person); ?></td>
<td><?php echo e($doc->contact_number); ?></td>
<td><?php echo e($doc->alertdays); ?></td>
<td>
  <button type="button" class="btn btn-primary btn-xs showinscertificates" value="<?php echo e($doc->id); ?>">View/Edit</button>
</td>
<td>
<button type="button"  class="btn btn-warning btn-xs editinsurance" value="<?php echo e($doc->id); ?>"><span class="glyphicon glyphicon-pencil"></span> </button>
<button type="button"  class="btn btn-danger btn-xs deleteinsurance" value="<?php echo e($doc->id); ?>"><span class="glyphicon glyphicon-trash"></span> </button>
</td>
</tr>
